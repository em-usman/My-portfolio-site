...
```sh
  cd my-folder
  git clone: (https://github.com/Muhammad-UsmanTariq/My-portfolio-site.git)
```
### Install
...
- GitHub: [Github](https://github.com/Muhammad-UsmanTariq)
- Twitter: [Twitter](https://twitter.com/@emosmantariq)
